...
if __name__ == "__main__":
    ...
    dataset_names = ["generate_moons", "mega_generate_blobs", "blood", "generate_blobs", "diabetes", "generate_circles", "generate_blob"]
    ...
    for dataset_name in dataset_names:
        ...
        for nb_model, black_box in enumerate(models):
            ...
            for instance_to_explain in x_test:
                ...
                try:
                    if average_distance_gf != average_distance_gs:
                        print("GF", "better" if average_distance_gf < average_distance_gs else "worse", "than GS")
                    if graph:
                        experimental_informations.store_experiments_information_instance([average_distance_gs, average_distance_gf], \
            ...
            if graph: experimental_informations.store_experiments_information(max_instance_to_explain, nb_model, \
                                                        'average_distance_' + str(k_closest) + '.csv', filename_all=filename_all)