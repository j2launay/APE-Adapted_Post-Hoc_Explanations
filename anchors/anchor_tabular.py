...
class AnchorTabularExplainer(object):
    ...
    def __init__(self, class_names, feature_names, train_data, categorical_names=None,
        ...
        if discretizer == 'quartile':
            ...
            self.disc = lime_tabular.MDLPDiscretizer(train_data,
                                                          self.categorical_features, 
                                                          self.feature_names,
                                                          labels=black_box_labels)
        elif discretizer == 'entropy':
            self.disc = lime_tabular.EntropyDiscretizer(train_data, 
                                                          self.categorical_features, 
                                                          self.feature_names,
                                                          labels=black_box_labels)
        elif discretizer == 'kmeans':
            self.disc = lime_tabular.KMeansDiscretizer(train_data, 
                                                          self.categorical_features, 
