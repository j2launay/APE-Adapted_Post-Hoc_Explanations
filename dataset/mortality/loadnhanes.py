...
def _load(biochemtapepath="./dataset/mortality/data/DU4800.txt", medexamtapepath='./dataset/mortality/data/DU4233.txt', 
         anthropometrypath="./dataset/mortality/data/DU4111.txt", vitlpath="./dataset/mortality/data/N92vitl.txt"):
    '''
